    ...
    <footer ref={sectionRef} className="bg-[#020b0d] text-base-100">
      <div className="min-h-screen flex items-center justify-center relative">
        <div className="h-full w-full">
          ...
          <div className="w-full flex justify-between items-start px-14">
            ...
            <div className="max-w-[500px]">
              <p className="mt-6 text-sm text-base-100/70">
        ...
        <Image
          ...
          height={0}
          sizes="100vw"
          className="h-auto w-[30%] absolute left-1/2 top-[53%] -translate-x-1/2 -translate-y-1/2"
          alt="Logo"
        />
      </div>
      ...
      <div className="flex flex-col gap-2 justify-center items-center py-11">
        <Image
          ...
          alt="Logo"
        />
        <p>© 2025 Himpunan Mahasiswa Informatika Universitas Diponegoro</p>
      </div>
    </footer>
  );
};
